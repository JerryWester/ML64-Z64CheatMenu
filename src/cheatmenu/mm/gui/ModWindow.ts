...
function renderDungeonItemTabs(core: Z64API.MM.IMMCore, ImGui: IImGui) {
...
function renderQuestItemTabs(core: Z64API.MM.IMMCore, emulator: IMemory, ImGui: IImGui) {
    if (ImGui.beginTabBar("Quest Items")) {
        if (!subWindowsOpen.item_tabs.quest_item_tabs.dungeon_items[0]) {
            if (ImGui.beginTabItem("Dungeon Items")) {
                ...
                renderDungeonItemTabs(core, ImGui);
                ImGui.endTabItem();
            }
        }
...
function renderItemTabs(core: Z64API.MM.IMMCore, emulator: IMemory, ImGui: IImGui) {
...
function renderCheatMenuTabs(core: Z64API.MM.IMMCore, emulator: IMemory, ImGui: IImGui) {
...
export function renderModWindow(core: Z64API.MM.IMMCore, emulator: IMemory, ImGui: IImGui) {
    if (subWindowsOpen.item_tabs.quest_item_tabs.dungeon_item_tabs.woodfall[0]) {
